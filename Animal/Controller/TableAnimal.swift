...
class TableAnimal: UITableViewController {
var animais = [Animal]()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "linhaAnimal", for: indexPath) as? LinhaAnimal
        cell?.nomeAnimal.text = animais[indexPath.row].nome
        cell?.familiaAnimal.text = animais[indexPath.row].familia
